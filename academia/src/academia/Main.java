...
public class Main {
	...
	// Método para Crear objetos en la base de datos
		...
		public static void ejecutaOQL(String hostname, String dbname) {
			...
			try {
				...
				while (rset.next()) {
					...
					System.out.println("Profesor: " + String.format("%10s",  a1.getNombre()) + String.format("%16s",  a1.getApellidos()) + "    Telefono: " + String.format("%10s", a1.getTelefono()) +"    DNI: " + String.format("%10s", a1.getDni()));
				}
		...
		public static void main(String[] args) {
			...
			modificaObjetos(hostname, dbname, "Rodolfo", "Ramirez Tomares", 620345345, "30258789Z");
